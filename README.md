...
- **Preprod Users Registry:** [USERS.md](./USERS.md) *(Target: 50 genuine Preprod users · Current: 20/50 In Progress)*
...
- **Current status**: `20 / 50` *(Active Onboarding Phase · 20 on-chain verified participants, remaining 30 in progress)*
...
| :--- | :---: | :---: | :--- |
| **Preprod Users** | 50 genuine Preprod users | `20 / 50` *(In Progress)* | [USERS.md](./USERS.md) *(public Preprod wallet addresses verified via Indexer / contract state)* |
