...
- **Preprod Users Registry:** [USERS.md](./USERS.md) *(Target: 50 genuine Preprod users · Current: 10/50 In Progress)*
...
- **Current status**: `10 / 50` *(Active Onboarding Phase · 10 on-chain verified participants, remaining 40 in progress)*
...
| :--- | :---: | :---: | :--- |
| **Preprod Users** | 50 genuine Preprod users | `10 / 50` *(In Progress)* | [USERS.md](./USERS.md) *(public Preprod wallet addresses verified via Indexer / contract state)* |
